...
#			nonlinearity=lasagne.nonlinearities.tanh))
	...
	print("Training ...")
	ftrain = open('train_lstm_miniute.txt', 'wb')
	fval = open('val_lstm_miniute.txt', 'wb')
	ftest = open('test_lstm_miniute.txt', 'wb')
	p = 0
	last_cost_val = 10000
	best_cost_val = 10000
	try:
		...
		for it in xrange(NUM_EPOCHS):
			...
			#	y = T.argmax(y,axis=1)
				ftrain.write("p = {} , sample = {},predicted = {}, actual_value = {}\n"
						.format((p),(x),(pred), (y)))
